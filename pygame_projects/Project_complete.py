...
bgimg=pygame.image.load("Ahmed.jpg")
bgimg=pygame.transform.scale(bgimg,(screen_height,screen_width)).convert_alpha()

# Game Title
pygame.display.set_caption("This Game is Make By Sajjad Hussain")
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.KEYDOWN:
                if event.key == pygame.K_SPACE:
                    pygame.mixer.music.load("best.mp3")
    ...
    while not exit_game:
        if game_over:
            ...
            if head in snk_list[:-1]:
                game_over = True
                pygame.mixer.music.load("rng.mp3")
                pygame.mixer.music.play()
